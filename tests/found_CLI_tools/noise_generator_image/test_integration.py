...
class IntegrationTest(unittest.TestCase):
    ...
    def test_interactive_with_random_parameters(self, mock_create, mock_resize,
                                               mock_window, mock_destroy,
                                               mock_imwrite, mock_imshow,
                                               mock_get, mock_wait):
    ...
    @patch('src.found_CLI_tools.noise_generator_image.__main__.cv2.resizeWindow')
    @patch('src.found_CLI_tools.noise_generator_image.__main__.cv2.createTrackbar')
    def test_interactive_parameter_scaling(self, mock_create, mock_resize,
                                          mock_window, mock_destroy,
                                          mock_imshow, mock_get, mock_wait):
    ...
    def test_main_with_valid_images(self):
        ...
        for _ in range(TESTS):
            ...
            with patch('sys.argv', test_args):
                with patch('src.found_CLI_tools.noise_generator_image.__main__.interactive_noise_adjustment') as mock:
