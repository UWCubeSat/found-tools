...
def main():
    ...
    # Radius residuals vs range (all passes)
    print("  Creating radius residuals vs range plot...")
    tester.plot_radius_residuals_vs_range(
        target=TargetBody.MOON,
        filename="figure_7_moon_radius_all_passes.png"
    )
    
    # Centroid residuals in illumination frame
    print("  Creating centroid residuals in illumination frame plot...")
    tester.plot_centroid_residuals_in_illumination_frame(
        target=TargetBody.MOON,
