...
def process_simulation(coeffs_nx6, width, height, output_folder, batch_size=200, sigma=2.0):
    ...
    with ThreadPoolExecutor(max_workers=8) as executor:
        for i in tqdm(range(0, n_total, batch_size), desc="Batches"):
            ...
            save_tasks = [(batch_cpu[j], os.path.join(output_folder, f"img_{i+j:06d}.png")) 
